...
const ingredients = [
  ...
  ingredient("beef_lean_cooked", "Halal lean beef", "Protein", "cooked", 217, 27, 0, 11.8, 0, { ...meat, aliases: ["lean beef steak", "lean beef strips", "lean beef mince", "lean beef kofta"] }),
  ingredient("lamb_lean_cooked", "Halal lean lamb", "Protein", "cooked", 206, 28, 0, 9.2, 0, meat),
...
const lunchBlueprints = [
  ...
  ["Spiced Chicken Onion Rice Bowl", M, "chicken_thigh_cooked", "rice_brown_cooked", "onion", "herbs_spices"],
  ...
  ["Tuna Hummus Mezze Bowl", M, "tuna_water_drained", null, "mixed_salad", "hummus"],
...
const dinnerBlueprints = [
  ["Grilled Chicken Tahini Plate", M, "chicken_breast_cooked", "rice_basmati_cooked", "mixed_salad", "tahini"],
  ["Spiced Lamb Roasted Potato Plate", M, "lamb_lean_cooked", "potato_roasted", "tomato", "yogurt_cucumber_sauce"],
  ["Baked Fish Pepper Tahini Plate", M, "white_fish_cooked", "rice_brown_cooked", "bell_pepper", "tahini"],
  ...
  ["Salmon Cauliflower Quinoa Bowl", "International", "salmon_cooked", "quinoa_cooked", "cauliflower", "lemon_juice"],
